...
var defKey2defName = function (key) {
    return "" + key[0].toUpperCase() + key.slice(1).replace(/[^a-zA-Z0-9$_]/g, '_');
};
...
var of2Values = function (obj) {
    var values = (obj.oneOf || obj.allOf || obj.anyOf || [])
        .map(function (p) { return exports.schema2value(p); })
        .filter(function (v) { return v; });
    return values.length ? values : null;
};
var object2value = function (obj) {
    var _a;
    ...
    if (additionalProps) {
        var val = additionalProps === true
            ...
            : exports.schema2value(additionalProps);
        if (val)
            value.push({
                name: '[key: string]',
                required: true,
...
var schema2value = function (schema, isResponse) {
    var _a, _b;
    if (!schema)
        return null;
    var isArray = false;
    ...
    if (exports.isRefObject(schema)) {
        ...
        if (schema.oneOf || schema.allOf || schema.anyOf) {
            ...
            isArray = true;
            value = exports.schema2value(schema.items);
        }
