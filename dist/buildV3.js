...
exports.default = (function (openapi) {
    var _a, _b, _c, _d;
    var files = [];
    var schemas = schemas2Props_1.default((_a = openapi.components) === null || _a === void 0 ? void 0 : _a.schemas, openapi) || [];
    var parameters = parameters2Props_1.default((_b = openapi.components) === null || _b === void 0 ? void 0 : _b.parameters, openapi) || [];
    files.push.apply(files, __spreadArray([], __read(Object.keys(openapi.paths)
        ...
        var methods = methodProps
            ...
            if (target.parameters || openapi.paths[path].parameters) {
                ...
                __spreadArray(__spreadArray([], __read((openapi.paths[path].parameters || []))), __read((target.parameters || []))).forEach(function (p) {
                    ...
                    if (converters_1.isRefObject(p)) {
                        ...
                        var value = converters_1.schema2value(p.schema);
                        if (!value)
                            return;
                        var prop = {
            ...
            if (target.responses) {
                var code = Object.keys(target.responses).find(function (code) { return code.match(/^(20\d|30\d)$/); });
                if (code) {
                    params.push({
                        name: 'status',
                        required: true,
                    ...
                    if (content === null || content === void 0 ? void 0 : content.schema) {
                        var val = converters_1.schema2value(content.schema, true);
                        val &&
                            params.push({
                                name: 'resBody',
                                required: true,
                            ...
                            values: [
                                {
                                    ...
                                    value: Object.keys(ref_1.headers)
                                        ...
                                        var val = converters_1.isRefObject(headerData)
                                            ...
                                            : converters_1.schema2value(headerData.schema);
                                        return (val && {
                                            name: converters_1.getPropertyName(header),
                                            required: converters_1.isRefObject(headerData)
                                                ? true
                                                : (_a = headerData.required) !== null && _a !== void 0 ? _a : true,
